...
<body>
	...
	<h1 class="centerH">
		Installation Settings for <span class="titProduct">api_ref_guide</span>&nbsp;<span
			class="titProduct">2.0</span>
	</h1>
	<div class="panel">
...
// 						echo "No database structure has been yet performed!";
			...
			if ($continue){
				...
				echo "<br/>\n<div class=\"removeInfo\">Please remove the \"".$baseDir0.DIRECTORY_SEPARATOR."install".DIRECTORY_SEPARATOR."*.php\" files after install!</div>";
