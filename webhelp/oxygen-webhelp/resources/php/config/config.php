<?php 
### CONFIGURATION FILE AUTOMATICALLY GENERATED BY THE OXYGEN WEBHELP INSTALLER AT 2014-08-02 01:02:45 ###
### for webhelp 3.6.0 

// The URL where the webhelp is installed on with trailing /
define('__BASE_URL__',"http://localhost/webhelp/");

// The relative URL where the webhelp is installed on with trailing /
define('__BASE_PATH__',"/webhelp/");
